...
public class RateLoader {
	...
	/**
	 * extracts data from a line an pushes to exchange You can configure behavior by
	 * over-riding getLinePattern, getCurrencyGroup and getRateGroup
	 * 
	 * @param line
	 * @param exchange
	 */
	...
	/**
	 * overriding this requires overriding getCurrencyGroup & getRateGroup to match.
	 * 
